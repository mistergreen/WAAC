    ...
    JsonObject& doc)
{
   // First call father deserialization
    ...
    actions[0] = doc["actions0"];
    actions[1] = doc["actions1"];
    actions[2] = doc["actions2"];
    actions[3] = doc["actions3"];
    devicesId[0] = doc["device0"];
    devicesId[1] = doc["device1"];
    devicesId[2] = doc["device2"] ;
    devicesId[3] = doc["device3"];
